...
rt_key = "gssrv2f56umush257ujrf296"
    ...
    begin
      ...
      if resp.code == '200'
        ...
        if data['total'] != 0     
          ...
          # use the audience_score score
          movie.rating = data['movies'][0]['ratings']['audience_score'].to_i
          movie.critic = data['movies'][0]['ratings']['critics_score'].to_i
